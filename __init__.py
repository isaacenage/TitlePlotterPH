...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load TitlePlotterPhilippineLandTitles class from file Title_Plotter_Philippine_Land_Titles.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .Title_Plotter_Philippine_Land_Titles import TitlePlotterPhilippineLandTitles
